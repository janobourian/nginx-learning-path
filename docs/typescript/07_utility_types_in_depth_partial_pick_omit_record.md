# Track 5, Module 8: Utility Types In Depth Partial Pick Omit Record

## 1. Opening: Beginner to Expert Progression

Welcome to Module 8 of the TypeScript Enterprise Type System track. In this module, we explore **Utility Types In Depth Partial Pick Omit Record**.
