# Track 5, Module 4: Generics Type Constraints And Variance

## 1. Opening: Beginner to Expert Progression

Welcome to Module 4 of the TypeScript Enterprise Type System track. In this module, we explore **Generics Type Constraints And Variance**.
