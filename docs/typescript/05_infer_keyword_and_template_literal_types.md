# Track 5, Module 6: Infer Keyword And Template Literal Types

## 1. Opening: Beginner to Expert Progression

Welcome to Module 6 of the TypeScript Enterprise Type System track. In this module, we explore **Infer Keyword And Template Literal Types**.
