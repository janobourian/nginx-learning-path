# Module 8: Platform Channels: MethodChannel, Swift, and Kotlin
Track 12: Flutter for Mobile & Impeller Graphics Engine

## 1. Opening: Platform Channels: MethodChannel, Swift, and Kotlin

### Concept
Welcome to Platform Channels: MethodChannel, Swift, and Kotlin. In the world of Flutter, understanding this concept is critical for building high-performance, robust mobile applications. Flutter represents a fundamental shift in mobile app development by drawing its own UI components directly to the screen via a highly optimized engine (like Impeller), rather than wrapping OEM platform widgets.
...
|-----|-----------|-------------|
| `MethodChannel('channel.name')` | `void MethodChannel('channel_name')(...)` | Essential operation for managing `MethodChannel('channel.name')` within the Flutter framework. |
| `invokeMethod<T>('methodName')` | `void invokeMethod<T>('methodName')(...)` | Essential operation for managing `invokeMethod<T>('methodName')` within the Flutter framework. |
| `setMethodCallHandler` | `void setMethodCallHandler(...)` | Essential operation for managing `setMethodCallHandler` within the Flutter framework. |
| `MethodCall` | `void MethodCall(...)` | Essential operation for managing `MethodCall` within the Flutter framework. |
| `FlutterMethodCallHandler` | `void FlutterMethodCallHandler(...)` | Essential operation for managing `FlutterMethodCallHandler` within the Flutter framework. |
| `MethodChannelResult` | `void MethodChannelResult(...)` | Essential operation for managing `MethodChannelResult` within the Flutter framework. |
| `BinaryMessenger` | `void BinaryMessenger(...)` | Essential operation for managing `BinaryMessenger` within the Flutter framework. |
| `FlutterEngine` | `void FlutterEngine(...)` | Essential operation for managing `FlutterEngine` within the Flutter framework. |
| `FlutterViewController` | `void FlutterViewController(...)` | Essential operation for managing `FlutterViewController` within the Flutter framework. |
| `FlutterActivity` | `void FlutterActivity(...)` | Essential operation for managing `FlutterActivity` within the Flutter framework. |
| `StandardMessageCodec` | `void StandardMessageCodec(...)` | Essential operation for managing `StandardMessageCodec` within the Flutter framework. |
| `JSONMessageCodec` | `void JSONMessageCodec(...)` | Essential operation for managing `JSONMessageCodec` within the Flutter framework. |
| `StringCodec` | `void StringCodec(...)` | Essential operation for managing `StringCodec` within the Flutter framework. |
| `BinaryCodec` | `void BinaryCodec(...)` | Essential operation for managing `BinaryCodec` within the Flutter framework. |
| `BasicMessageChannel` | `void BasicMessageChannel(...)` | Essential operation for managing `BasicMessageChannel` within the Flutter framework. |
| `MethodChannel.invokeMapMethod` | `void MethodChannel_invokeMapMethod(...)` | Essential operation for managing `MethodChannel.invokeMapMethod` within the Flutter framework. |
| `MethodChannel.invokeListMethod` | `void MethodChannel_invokeListMethod(...)` | Essential operation for managing `MethodChannel.invokeListMethod` within the Flutter framework. |
| `PlatformException` | `void PlatformException(...)` | Essential operation for managing `PlatformException` within the Flutter framework. |
| `MissingPluginException` | `void MissingPluginException(...)` | Essential operation for managing `MissingPluginException` within the Flutter framework. |
| `FlutterPlugin` | `void FlutterPlugin(...)` | Essential operation for managing `FlutterPlugin` within the Flutter framework. |
...
To further understand the intricacies of Platform Channels: MethodChannel, Swift, and Kotlin, let's examine additional architectural patterns.
