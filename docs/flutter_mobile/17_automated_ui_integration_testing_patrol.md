# Module 17: Automated UI Integration Testing: Patrol

Track 12: Flutter for Mobile & Impeller Graphics Engine

## 1. Opening: Automated UI Integration Testing: Patrol

### Concept

Welcome to Automated UI Integration Testing: Patrol. In the world of Flutter, understanding this concept is critical for building high-performance, robust mobile applications. Flutter represents a fundamental shift in mobile app development by drawing its own UI components directly to the screen via a highly optimized engine (like Impeller), rather than wrapping OEM platform widgets.
...
| ----- | ----------- | ------------- |
| `patrolTest()` | `void patrolTest(...)` | Essential operation for managing `patrolTest()` within the Flutter framework. |
| `$()` | `void $(...)` | Essential operation for managing `$()` within the Flutter framework. |
| `$('Button').tap()` | `void $('Button')_tap(...)` | Essential operation for managing `$('Button').tap()` within the Flutter framework. |
| `$(Finder).enterText()` | `void $(Finder)_enterText(...)` | Essential operation for managing `$(Finder).enterText()` within the Flutter framework. |
| `native.tap()` | `void native_tap(...)` | Essential operation for managing `native.tap()` within the Flutter framework. |
| `native.enterText()` | `void native_enterText(...)` | Essential operation for managing `native.enterText()` within the Flutter framework. |
| `native.grantPermission()` | `void native_grantPermission(...)` | Essential operation for managing `native.grantPermission()` within the Flutter framework. |
| `native.pressHome()` | `void native_pressHome(...)` | Essential operation for managing `native.pressHome()` within the Flutter framework. |
| `native.pressBack()` | `void native_pressBack(...)` | Essential operation for managing `native.pressBack()` within the Flutter framework. |
| `native.openNotifications()` | `void native_openNotifications(...)` | Essential operation for managing `native.openNotifications()` within the Flutter framework. |
| `native.openQuickSettings()` | `void native_openQuickSettings(...)` | Essential operation for managing `native.openQuickSettings()` within the Flutter framework. |
| `native.enableWifi()` | `void native_enableWifi(...)` | Essential operation for managing `native.enableWifi()` within the Flutter framework. |
| `native.disableWifi()` | `void native_disableWifi(...)` | Essential operation for managing `native.disableWifi()` within the Flutter framework. |
| `native.enableCellular()` | `void native_enableCellular(...)` | Essential operation for managing `native.enableCellular()` within the Flutter framework. |
| `native.disableCellular()` | `void native_disableCellular(...)` | Essential operation for managing `native.disableCellular()` within the Flutter framework. |
| `native.enableDarkMode()` | `void native_enableDarkMode(...)` | Essential operation for managing `native.enableDarkMode()` within the Flutter framework. |
| `native.disableDarkMode()` | `void native_disableDarkMode(...)` | Essential operation for managing `native.disableDarkMode()` within the Flutter framework. |
| `Pump` | `void Pump(...)` | Essential operation for managing `Pump` within the Flutter framework. |
| `Settle` | `void Settle(...)` | Essential operation for managing `Settle` within the Flutter framework. |
| `integration_test` | `void integration_test(...)` | Essential operation for managing `integration_test` within the Flutter framework. |
...
To further understand the intricacies of Automated UI Integration Testing: Patrol, let's examine additional architectural patterns.
