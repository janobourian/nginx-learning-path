# Module 14: Internationalization (L10n) and Localization
Track 12: Flutter for Mobile & Impeller Graphics Engine

## 1. Opening: Internationalization (L10n) and Localization

### Concept
Welcome to Internationalization (L10n) and Localization. In the world of Flutter, understanding this concept is critical for building high-performance, robust mobile applications. Flutter represents a fundamental shift in mobile app development by drawing its own UI components directly to the screen via a highly optimized engine (like Impeller), rather than wrapping OEM platform widgets.
...
|-----|-----------|-------------|
| `MaterialApp.localizationsDelegates` | `void MaterialApp_localizationsDelegates(...)` | Essential operation for managing `MaterialApp.localizationsDelegates` within the Flutter framework. |
| `MaterialApp.supportedLocales` | `void MaterialApp_supportedLocales(...)` | Essential operation for managing `MaterialApp.supportedLocales` within the Flutter framework. |
| `Intl` | `void Intl(...)` | Essential operation for managing `Intl` within the Flutter framework. |
| `AppLocalizations.of(context)` | `void AppLocalizations_of(context)(...)` | Essential operation for managing `AppLocalizations.of(context)` within the Flutter framework. |
| `GlobalMaterialLocalizations.delegate` | `void GlobalMaterialLocalizations_delegate(...)` | Essential operation for managing `GlobalMaterialLocalizations.delegate` within the Flutter framework. |
| `GlobalWidgetsLocalizations.delegate` | `void GlobalWidgetsLocalizations_delegate(...)` | Essential operation for managing `GlobalWidgetsLocalizations.delegate` within the Flutter framework. |
| `GlobalCupertinoLocalizations.delegate` | `void GlobalCupertinoLocalizations_delegate(...)` | Essential operation for managing `GlobalCupertinoLocalizations.delegate` within the Flutter framework. |
| `Locale('en', 'US')` | `void Locale('en', 'US')(...)` | Essential operation for managing `Locale('en', 'US')` within the Flutter framework. |
| `l10n.yaml` | `void l10n_yaml(...)` | Essential operation for managing `l10n.yaml` within the Flutter framework. |
| `arb-dir` | `void arb-dir(...)` | Essential operation for managing `arb-dir` within the Flutter framework. |
| `template-arb-file` | `void template-arb-file(...)` | Essential operation for managing `template-arb-file` within the Flutter framework. |
| `output-localization-file` | `void output-localization-file(...)` | Essential operation for managing `output-localization-file` within the Flutter framework. |
| `intl_translation` | `void intl_translation(...)` | Essential operation for managing `intl_translation` within the Flutter framework. |
| `Intl.message()` | `void Intl_message(...)` | Essential operation for managing `Intl.message()` within the Flutter framework. |
| `Intl.plural()` | `void Intl_plural(...)` | Essential operation for managing `Intl.plural()` within the Flutter framework. |
| `Intl.gender()` | `void Intl_gender(...)` | Essential operation for managing `Intl.gender()` within the Flutter framework. |
| `Intl.select()` | `void Intl_select(...)` | Essential operation for managing `Intl.select()` within the Flutter framework. |
| `NumberFormat` | `void NumberFormat(...)` | Essential operation for managing `NumberFormat` within the Flutter framework. |
| `DateFormat` | `void DateFormat(...)` | Essential operation for managing `DateFormat` within the Flutter framework. |
| `Directionality` | `void Directionality(...)` | Essential operation for managing `Directionality` within the Flutter framework. |
...
To further understand the intricacies of Internationalization (L10n) and Localization, let's examine additional architectural patterns.
