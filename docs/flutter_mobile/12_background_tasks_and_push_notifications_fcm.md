# Module 12: Background Tasks and Push Notifications (FCM)

Track 12: Flutter for Mobile & Impeller Graphics Engine

## 1. Opening: Background Tasks and Push Notifications (FCM)

### Concept

Welcome to Background Tasks and Push Notifications (FCM). In the world of Flutter, understanding this concept is critical for building high-performance, robust mobile applications. Flutter represents a fundamental shift in mobile app development by drawing its own UI components directly to the screen via a highly optimized engine (like Impeller), rather than wrapping OEM platform widgets.
...
| ----- | ----------- | ------------- |
| `FirebaseMessaging` | `void FirebaseMessaging(...)` | Essential operation for managing `FirebaseMessaging` within the Flutter framework. |
| `getToken()` | `void getToken(...)` | Essential operation for managing `getToken()` within the Flutter framework. |
| `onMessage` | `void onMessage(...)` | Essential operation for managing `onMessage` within the Flutter framework. |
| `onMessageOpenedApp` | `void onMessageOpenedApp(...)` | Essential operation for managing `onMessageOpenedApp` within the Flutter framework. |
| `onBackgroundMessage` | `void onBackgroundMessage(...)` | Essential operation for managing `onBackgroundMessage` within the Flutter framework. |
| `RemoteMessage` | `void RemoteMessage(...)` | Essential operation for managing `RemoteMessage` within the Flutter framework. |
| `NotificationSettings` | `void NotificationSettings(...)` | Essential operation for managing `NotificationSettings` within the Flutter framework. |
| `requestPermission()` | `void requestPermission(...)` | Essential operation for managing `requestPermission()` within the Flutter framework. |
| `subscribeToTopic()` | `void subscribeToTopic(...)` | Essential operation for managing `subscribeToTopic()` within the Flutter framework. |
| `unsubscribeFromTopic()` | `void unsubscribeFromTopic(...)` | Essential operation for managing `unsubscribeFromTopic()` within the Flutter framework. |
| `Workmanager` | `void Workmanager(...)` | Essential operation for managing `Workmanager` within the Flutter framework. |
| `executeTask` | `void executeTask(...)` | Essential operation for managing `executeTask` within the Flutter framework. |
| `registerOneOffTask` | `void registerOneOffTask(...)` | Essential operation for managing `registerOneOffTask` within the Flutter framework. |
| `registerPeriodicTask` | `void registerPeriodicTask(...)` | Essential operation for managing `registerPeriodicTask` within the Flutter framework. |
| `CancelTask` | `void CancelTask(...)` | Essential operation for managing `CancelTask` within the Flutter framework. |
| `flutter_local_notifications` | `void flutter_local_notifications(...)` | Essential operation for managing `flutter_local_notifications` within the Flutter framework. |
| `FlutterLocalNotificationsPlugin` | `void FlutterLocalNotificationsPlugin(...)` | Essential operation for managing `FlutterLocalNotificationsPlugin` within the Flutter framework. |
| `show()` | `void show(...)` | Essential operation for managing `show()` within the Flutter framework. |
| `NotificationDetails` | `void NotificationDetails(...)` | Essential operation for managing `NotificationDetails` within the Flutter framework. |
| `AndroidNotificationDetails` | `void AndroidNotificationDetails(...)` | Essential operation for managing `AndroidNotificationDetails` within the Flutter framework. |
...
To further understand the intricacies of Background Tasks and Push Notifications (FCM), let's examine additional architectural patterns.
