...
10. [Step-by-Step Production Lab: Hardened TLS 1.3 & HTTP/2 / HTTP/3 Gateway](#10-step-by-step-production-lab-hardened-tls-13--http2--http3-gateway)
...
1. [Ivan Ristić: Bulletproof TLS and PKI (2nd Edition, Feisty Duck)](https://www.feistyduck.com/books/bulletproof-tls-and-pki/)
2. [Ilya Grigorik: High Performance Browser Networking (O'Reilly)](https://hpbn.co/)
3. [Cloudflare Engineering: Road to QUIC and HTTP/3 Deployment](https://blog.cloudflare.com/)
4. [Datadog Engineering: Monitoring TLS Handshake Latency and Certificate Expiry](https://www.datadoghq.com/blog/)
5. [Qualys SSL Labs: SSL/TLS Deployment Best Practices](https://www.ssllabs.com/)
