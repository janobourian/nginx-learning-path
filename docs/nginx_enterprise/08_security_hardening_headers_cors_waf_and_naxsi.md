...
10. [Step-by-Step Production Lab: Enterprise Hardened Security Gateway](#10-step-by-step-production-lab-enterprise-hardened-security-gateway)
...
1. [Ivan Ristić: ModSecurity Handbook (2nd Edition, Feisty Duck)](https://www.feistyduck.com/books/modsecurity-handbook/)
2. [Derek DeJonghe: NGINX Cookbook (Security and Access Controls)](https://www.oreilly.com/)
3. [Cloudflare Engineering: Deploying Content Security Policy Without Breaking Websites](https://blog.cloudflare.com/)
4. [Datadog Engineering: Real-Time Detection of Web Application Exploits at the Edge](https://www.datadoghq.com/blog/)
5. [High-Performance Linux Systems: Low-Overhead In-Memory WAF Inspection](https://www.kernel.org/)
